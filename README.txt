...
4. In order to start MongoDB database service go to (..\MEAN stack application\API\backend\) and type (mongod). Note: must have MongoDB installed on your computer!
